...
if [ $# -eq 0 ]
  then
    ...
    echo "Usage: ./run_main_gpt5.sh <expt_name> <openai_model_name> <max_tokens> <data_path> [--demo]"
    exit 1
fi

openai_model_name="gpt-5-thinking-nano"
max_tokens=1000
...
command="""python main_gpt5.py --data_path $data_path \
...
# bash ./run_main_gpt5.sh dep_list_phq9items_score_classify2  gpt-5 1500 '/chronos_data/avirinchipur/reasoning_for_psych/kjell_prolific/depTextOnly.csv'